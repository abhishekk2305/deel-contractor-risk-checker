...
async function seedAllCountries() {
  console.log(`🌍 Seeding all ${fullCountriesList.length} countries...`);
  ...
  console.log(`   - Total countries in database: ${totalCount.count}`);
}

if (require.main === module) {
  seedAllCountries().catch(console.error);
}

export { seedAllCountries };