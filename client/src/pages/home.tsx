...
import { FeaturedCountries } from "@/components/search/featured-countries";
...
import { useCountries, useFeaturedCountries } from "@/hooks/use-countries";
...
export default function Home() {
  ...
  const { data: featuredCountries, isLoading: featuredLoading } = useFeaturedCountries();
  ...
  return (
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <Navigation activeTab="search" onTabChange={handleTabChange} />
